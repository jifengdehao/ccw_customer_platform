  ...
  <div class="addCoupon">
    ...
    <div class="content">
      <ul>
        ...
        <li><span>劵名</span><span><textarea v-model="addCoupon.couponName" class="remake" placeholder="最多输入50个字" maxlength="50"></textarea></span></li>
        ...
        <li><span>备注信息</span><span><textarea v-model="addCoupon.remark" class="remake" placeholder="最多输入50个字" maxlength="50"></textarea></span></li>
      </ul>
    </div>
    <div class="footer">
...
export default {
  data() {
    return {
      ...
      addCoupon: {
        types: 1, // 发放类型
        couponAttribute: '常规券', //  优惠券属性
        couponName: '', // 优惠券名称
        useCondition: '0', // 使用条件
        discount: '', // 优惠价格
        amount: '无限制', // 发放数量
        couponLimit: '发券周期内限领1张', // 领券规则
        couponSet: '新用户可领', // 领券设置
